...
gdjs.victoryCode.condition0IsTrue_0.val = false;
{
gdjs.victoryCode.condition0IsTrue_0.val = gdjs.evtTools.runtimeScene.timerElapsedTime(runtimeScene, 7, "video");
}if (gdjs.victoryCode.condition0IsTrue_0.val) {
{gdjs.evtTools.window.openURL("https://youtu.be/Ob9VgMRWaDg", runtimeScene);
}{gdjs.evtTools.runtimeScene.removeTimer(runtimeScene, "video");
}}
